...
function QuerySelect(
  ...
  return createElement(
    ...
    { ...rest },
    ...childArray,
  ) as TypedConstructNode<"Query.Select">
}
...
function QueryWhere(props: QueryWhereProps): TypedConstructNode<"Query.Where"> {
  ...
  return createElement(
    ...
    { ...rest },
    ...childArray,
  ) as TypedConstructNode<"Query.Where">
}
...
function QueryGroupBy(
  ...
  return createElement(
    ...
    { ...rest },
    ...childArray,
  ) as TypedConstructNode<"Query.GroupBy">
}
...
function QueryHaving(
  ...
  return createElement(
    ...
    { ...rest },
    ...childArray,
  ) as TypedConstructNode<"Query.Having">
}
...
function QueryOrderBy(
  ...
  return createElement(
    ...
    { ...rest },
    ...childArray,
  ) as TypedConstructNode<"Query.OrderBy">
}
...
function QueryFactory(props: QueryProps): ConstructNode {
  ...
  const clauseChildren = childArray.filter((c) =>
  ...
  const hasHaving = clauseChildren.some((c) => c.component === "Query.Having")
  const hasGroupBy = clauseChildren.some((c) => c.component === "Query.GroupBy")
