...
export function getMonorepoTemplates(opts: ScaffoldOptions): TemplateFile[] {
  ...
  return [
    { path: 'package.json', content: JSON.stringify(workspacePkg, null, 2) + '\n' },
    ...
    // packages/schemas
    { path: 'packages/schemas/package.json', content: JSON.stringify(schemasPkg, null, 2) + '\n' },
    {
...
`,
    ...
    // packages/patterns
    { path: 'packages/patterns/package.json', content: JSON.stringify(patternsPkg, null, 2) + '\n' },
    {
...
`,
    ...
    // apps/default-app
    { path: 'apps/default-app/package.json', content: JSON.stringify(appPkg, null, 2) + '\n' },
    {
