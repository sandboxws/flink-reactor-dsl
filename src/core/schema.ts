import type { FlinkType, FlinkPrimitiveType } from './types.js';
...
const PRIMITIVE_TYPES: ReadonlySet<string> = new Set<FlinkPrimitiveType>([
  ...
  'FLOAT', 'DOUBLE', 'STRING', 'DATE', 'TIME', 'BYTES',
]);
...
export interface SchemaDefinition<T extends Record<string, FlinkType> = Record<string, FlinkType>> {
  readonly fields: T;
...
export const Field = {
  BOOLEAN(): FlinkType { return 'BOOLEAN'; },
  TINYINT(): FlinkType { return 'TINYINT'; },
  SMALLINT(): FlinkType { return 'SMALLINT'; },
  INT(): FlinkType { return 'INT'; },
  BIGINT(): FlinkType { return 'BIGINT'; },
  FLOAT(): FlinkType { return 'FLOAT'; },
  DOUBLE(): FlinkType { return 'DOUBLE'; },
  STRING(): FlinkType { return 'STRING'; },
  DATE(): FlinkType { return 'DATE'; },
  TIME(): FlinkType { return 'TIME'; },
  BYTES(): FlinkType { return 'BYTES'; },
