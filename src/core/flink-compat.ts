...
const GATED_FEATURES: readonly GatedFeature[] = [
  { name: 'CREATE_MODEL', minVersion: '2.1', description: 'CREATE MODEL statement' },
  { name: 'VECTOR_SEARCH', minVersion: '2.2', description: 'VECTOR_SEARCH function' },
  { name: 'MATERIALIZED_TABLE', minVersion: '2.0', description: 'Materialized tables' },
];
...
export const FlinkVersionCompat = {
  ...
  isVersionAtLeast(version: FlinkMajorVersion, minVersion: FlinkMajorVersion): boolean {
