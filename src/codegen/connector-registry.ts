...
const VERSION_ORDER: readonly FlinkMajorVersion[] = ['1.20', '2.0', '2.1', '2.2'];
    ...
    versions: [
      {
        ...
        maxVersion: '1.20',
        artifacts: [
          { groupId: 'org.apache.flink', artifactId: 'flink-sql-connector-kafka', version: '3.3.0-1.20' },
        ],
      },
      {
        minVersion: '2.0',
        artifacts: [
          { groupId: 'org.apache.flink', artifactId: 'flink-sql-connector-kafka', version: '4.0.1-2.0' },
        ],
      },
    ],
  },
    ...
    versions: [
      {
        ...
        maxVersion: '1.20',
        artifacts: [
          { groupId: 'org.apache.flink', artifactId: 'flink-connector-jdbc', version: '3.2.0-1.20' },
        ],
      },
      {
        minVersion: '2.0',
        artifacts: [
          { groupId: 'org.apache.flink', artifactId: 'flink-connector-jdbc-core', version: '3.2.0-2.0' },
        ],
      },
    ],
  },
    ...
    versions: [
      {
        ...
        maxVersion: '1.20',
        artifacts: [
          { groupId: 'org.apache.flink', artifactId: 'flink-sql-connector-elasticsearch7', version: '4.0.0-1.20' },
        ],
      },
      {
        minVersion: '2.0',
        artifacts: [
          { groupId: 'org.apache.flink', artifactId: 'flink-sql-connector-elasticsearch7', version: '4.0.0-2.0' },
        ],
      },
    ],
  },
...
const FORMAT_REGISTRY: readonly FormatEntry[] = [
  ...
  },
  {
    ...
    builtIn: false,
    artifacts: [
      { groupId: 'org.apache.flink', artifactId: 'flink-sql-avro', version: '1.20.0' },
    ],
  },
  {
    formatId: 'parquet',
    builtIn: false,
    artifacts: [
      { groupId: 'org.apache.flink', artifactId: 'flink-sql-parquet', version: '1.20.0' },
    ],
  },
 ...
 */
export function lookupConnector(connectorId: string): ConnectorRegistryEntry | undefined {
...
export function resolveConnectorArtifacts(
  ...
  for (const v of entry.versions) {
    ...
    const meetsMax = v.maxVersion === undefined || versionLte(flinkVersion, v.maxVersion);
 ...
 */
export function detectJdbcDialect(jdbcUrl: string): JdbcDialectEntry | undefined {
 ...
 */
export function resolveFormatArtifacts(formatId: string): readonly MavenArtifact[] {
