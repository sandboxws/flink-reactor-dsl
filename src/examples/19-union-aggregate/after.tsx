...
import { Union, Map, Aggregate } from '../../components/transforms';
...
const mobile = (
  <KafkaSource topic="mobile_events" bootstrapServers="kafka:9092" schema={MobileEventSchema}>
    <Map select={{
...
const web = (
  <KafkaSource topic="web_events" bootstrapServers="kafka:9092" schema={WebEventSchema}>
    <Map select={{
      event_id: 'event_id', user_id: 'user_id',
      event_type: 'event_type', event_time: 'event_time',
      platform: "'web'",
...
const iot = (
  <KafkaSource topic="iot_events" bootstrapServers="kafka:9092" schema={IoTEventSchema}>
    <Map select={{
      event_id: 'event_id', user_id: 'device_id',
      event_type: 'event_type', event_time: 'event_time',
      platform: "'iot'",
    }} />
  </KafkaSource>
