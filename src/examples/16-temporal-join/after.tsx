...
const rates = (
  <KafkaSource topic="currency_rates" bootstrapServers="kafka:9092" schema={CurrencyRateSchema} />
);

const orders = (
  <KafkaSource topic="forex_orders" bootstrapServers="kafka:9092" schema={ForexOrderSchema} />
);
